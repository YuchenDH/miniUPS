...
public:
  ...
  typedef boost::shared_ptr<au_proto::Request> RequestPointer;
  typedef boost::shared_ptr<au_proto::Response> ResponsePointer;
  
  static Pointer create(asio::io_service& io_service, pqxx::connection& C) {
    return Pointer(new UpsConnection(io_service, C));
  }
